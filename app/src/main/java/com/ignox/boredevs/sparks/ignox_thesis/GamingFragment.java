...
public class GamingFragment extends Fragment {
    ...
    private String gamingnews_api = "https://newsapi.org/v1/articles?source=ign&sortBy=top&apiKey=086ca0991dc44757902c3b7bb786d2e8";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new GamingAdapter(v.getContext(), sourcesList);
        recyclerView = (RecyclerView) v.findViewById(R.id.headline_recycler);

        new GetGamingNews().execute();
    ...
    private class GetGamingNews extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL(gamingnews_api);
