...
public class MusicFragment extends Fragment {
    ...
    private String technews_api = "https://newsapi.org/v1/articles?source=mtv-news-uk&sortBy=top&apiKey=086ca0991dc44757902c3b7bb786d2e8";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MusicAdapter(v.getContext(), sourcesList);
        recyclerView = (RecyclerView) v.findViewById(R.id.headline_recycler);

        new GetMusicNews().execute();
    ...
    private class GetMusicNews extends AsyncTask<Void,Void,Void> {
