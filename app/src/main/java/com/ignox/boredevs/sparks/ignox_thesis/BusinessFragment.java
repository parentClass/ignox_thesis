...
public class BusinessFragment extends Fragment {
    ...
    private String businessnews_api = "https://newsapi.org/v1/articles?source=business-insider&sortBy=top&apiKey=086ca0991dc44757902c3b7bb786d2e8";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new BusinessAdapter(v.getContext(), sourcesList);
        recyclerView = (RecyclerView) v.findViewById(R.id.headline_recycler);

        new GetBusinessNews().execute();
    ...
    private class GetBusinessNews extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL(businessnews_api);
