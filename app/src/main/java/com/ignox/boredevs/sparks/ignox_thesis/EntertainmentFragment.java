...
public class EntertainmentFragment extends Fragment {
    ...
    private String entertainmentnews_api = "https://newsapi.org/v1/articles?source=the-lad-bible&sortBy=top&apiKey=086ca0991dc44757902c3b7bb786d2e8";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EntertainmentAdapter(v.getContext(), sourcesList);
        recyclerView = (RecyclerView) v.findViewById(R.id.headline_recycler);

        new GetEntertainmentNews().execute();
    ...
    private class GetEntertainmentNews extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL(entertainmentnews_api);
