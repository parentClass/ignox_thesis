...
public class ScienceFragment extends Fragment {
    ...
    private String sciencenews_api = "https://newsapi.org/v1/articles?source=new-scientist&sortBy=top&apiKey=086ca0991dc44757902c3b7bb786d2e8";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ScienceAdapter(v.getContext(), sourcesList);
        recyclerView = (RecyclerView) v.findViewById(R.id.headline_recycler);

        new GetScienceNews().execute();
    ...
    private class GetScienceNews extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL(sciencenews_api);
